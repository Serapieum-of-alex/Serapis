...
@pytest.fixture(scope="module")
def create_sub_instance_first_xs() -> int:
    return first_xs


@pytest.fixture(scope="module")
def sub_get_flow_lateral_table() -> List[int]:
    return segment1_laterals


@pytest.fixture(scope="module")
def create_sub_instance_last_xs() -> int:
    return last_xs
...
def overtopping_files_dir() -> str:
    return "tests/data/overtopping_files"


@pytest.fixture(scope="module")
def event_index_file() -> str:
    return "tests/data/event-index.txt"
